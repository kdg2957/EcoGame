...
// 뷰포트 높이 계산 및 적용 (모바일 하단 잘림 방지)
    ...
    const itemsPerMap = 13; // 맵 당 숨은 아이템 개수
    ...
    const mapItems = [
        ...
        [
            ...
            './images/cho1.png', './images/cho2.png', './images/cho3.png'
        ],
        // 두 번째 맵 (바다) 아이템
        [
            ...
            './images/pa1.png', './images/pa2.png', './images/pa3.png'
        ],
        // 세 번째 맵 (도시) 아이템
        [
            ...
            './images/bo1.png', './images/bo2.png', './images/bo3.png'
        ]
    ];
